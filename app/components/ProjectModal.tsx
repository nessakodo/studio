    ...
    <AnimatePresence>
      {isOpen && project && (
        <>
          ...
          >
            <div className="relative w-full max-w-2xl bg-black/90 backdrop-blur-xl rounded-xl border border-white/10 max-h-[80vh]">
              {/* Close button */}
              <button
                onClick={onClose}
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="space-y-4">
                  <h2
                    id="project-title"
                    className="text-xl md:text-2xl font-light text-transparent bg-clip-text bg-gradient-to-r from-sage-400 via-mist-400 to-mint-400 leading-tight"
                  >
                    {project.title}
                  </h2>
                  ...
                  {project.features && project.features.length > 0 && (
                    <div className="space-y-3">
                      <h3 className="text-base font-light text-white">Key Features</h3>
                  ...
                  <div className="flex flex-wrap gap-3 pt-4">
                    <Button
                      className="unified-button primary showcase-modal-button text-sm"
                      onClick={() => window.open(project.demo, "_blank")}
                    >
                      <span className="button-content">LIVE DEMO</span>
                    </Button>
                    <Button
                      className="unified-button showcase-modal-button text-sm"
